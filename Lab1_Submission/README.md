...
| File | What it is |
|------|------------|
| `Lab1_Requirements_Engineering_PES1UG24CS159.pdf` | All deliverables in one PDF (requirements table, use-case diagram, flow spec, flowchart) |
| `Requirements_Table.docx` | Requirements table on its own (Word) |
